    ...
    if (tab.showTasksPanel) {
        BottomSheetDialog(
            ...
            LazyColumn(Modifier.animateContentSize()) {
                items(globalClass.regularTabManager.regularTabTasks, key = { it.id }) { task ->
                    SwipeBox(
                        ...
                        endContent = { swipeableState, endSwipeProgress ->
                            SwipeIcon(
                                ...
                                globalClass.regularTabManager.regularTabTasks.removeIf { it.id == task.id }
                            ...
                            modifier = Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        ...
                                        if (task is RegularTabCompressTask) {
            ...
            AnimatedVisibility(visible = globalClass.regularTabManager.regularTabTasks.isEmpty()) {
                Text(
                    modifier = Modifier
