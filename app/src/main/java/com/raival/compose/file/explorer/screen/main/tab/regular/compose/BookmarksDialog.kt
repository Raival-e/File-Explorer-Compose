...
@Composable
fun BookmarksDialog(tab: RegularTab) {
    if (tab.showBookmarkDialog) {
        ...
        BottomSheetDialog(
            ...
            LazyColumn(Modifier.animateContentSize()) {
                itemsIndexed(globalClass.regularTabManager.bookmarks
                    ...
                    SwipeBox(
                        ...
                        endContent = { swipeableState, endSwipeProgress ->
                            SwipeIcon(
                                ...
                                globalClass.regularTabManager.bookmarks -= item.getPath()
                            }
                        }
                    ) { _, _, _ ->
                        Modifier
                                ...
                                .combinedClickable(
                                    onClick = {
                                        if (item.isFile()) {
                                            ...
                                            tab.requestNewTab(RegularTab(item))
                                        }
            ...
            AnimatedVisibility(globalClass.regularTabManager.bookmarks.isEmpty()) {
                Text(
                    modifier = Modifier
