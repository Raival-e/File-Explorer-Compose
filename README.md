...
[![Built with Jetpack Compose](https://img.shields.io/badge/Built%20with-Jetpack%20Compose-brightgreen)](https://developer.android.com/jetpack/compose)
[![Kotlin](https://img.shields.io/badge/Kotlin-1.8.20-blueviolet)](https://kotlinlang.org/)
...
*   **GitHub Releases:**  Download the APK directly from the [Releases page](https://github.com/Raival-e/File-Explorer-Compose/releases). This is the most direct way to get the app.
    [![Get it on GitHub](assets/badge_github.png)](https://github.com/Raival-e/File-Explorer-Compose/releases)
...
*   **IzzyOnDroid F-Droid Repository:**  Available on IzzyOnDroid for users who prefer F-Droid compatible repositories.
    [![Get it on IzzyOnDroid](assets/badge_IzzyOnDroid.png)](https://apt.izzysoft.de/fdroid/index/apk/com.raival.compose.file.explorer)
